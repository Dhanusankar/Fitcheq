        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/dashboard/exercises" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Exercise Library
                </Link>
              </li>
              <li>
                <Link href="/dashboard/nutrition" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Nutrition Tracking
                </Link>
              </li>
              <li>
                <Link href="/dashboard/progress" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Progress Tracking
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-600">
              © {new Date().getFullYear()} Fitcheq. All rights reserved.
            </p>
